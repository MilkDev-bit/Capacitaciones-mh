...
html.dark-theme .ia-title { color: #f8fafc; }
html.dark-theme .ia-desc { color: #94a3b8; }
html.dark-theme .game-hint,
html.dark-theme .topbar-hint { color: #cbd5e1 !important; }
...
html.dark-theme .ia-completed-overlay { background: rgba(10, 15, 26, 0.75); }
...
html.dark-theme .completed-topbar { border-color: rgba(16, 185, 129, 0.25); }
html.dark-theme .completed-status-badge { color: #34d399; }
html.dark-theme .completed-info-text { color: #e2e8f0; }
html.dark-theme .completed-info-text strong { color: #34d399; }
html.dark-theme .metric-box {
  background: rgba(15, 23, 42, 0.7);
  border-color: rgba(16, 185, 129, 0.3);
}
html.dark-theme .metric-title { color: #94a3b8; }
html.dark-theme .metric-value { color: #f8fafc; }
html.dark-theme .metric-value.status-saved { color: #34d399; }
...
/* 5: Memorama */
html.dark-theme .card-front { border-color: rgba(255, 255, 255, 0.25); }
html.dark-theme .card-back {
  background: rgba(30, 41, 59, 0.92);
  border-color: rgba(255, 255, 255, 0.15);
  box-shadow: 0 16px 36px rgba(0, 0, 0, 0.4), inset 0 1px 2px rgba(255, 255, 255, 0.1);
}
html.dark-theme .memo-card.matched .card-back { background: rgba(24, 32, 47, 0.96); }
html.dark-theme .card-txt { color: #f8fafc; }
...
html.dark-theme .cat-name { color: #f8fafc; }
...
html.dark-theme .ws-panel-title { color: #f8fafc; }
html.dark-theme .ws-word { color: #cbd5e1; }
...
html.dark-theme .fb-text { color: #f8fafc; }
...
html.dark-theme .order-txt { color: #f8fafc; }
...
html.dark-theme .hm-hint-text { color: #f8fafc; }
html.dark-theme .hm-lives-label { color: #e2e8f0; }
