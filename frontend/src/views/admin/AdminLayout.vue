  ...
  <div class="shell">
    ...
    <aside :class="['sidebar-nav', sidebarOpen ? 'open' : '']">
      ...
      <nav>
        ...
        <RouterLink to="/admin/schedules" @click="sidebarOpen = false">
          <svg class="nav-icon" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
          Horarios
        </RouterLink>
      </nav>
      <div class="sn-footer">
