...
<template>
  <div class="layout">
    <aside class="sidebar">
      ...
      <nav>
        <RouterLink to="/instructor/capacitaciones">
          <span class="icon">📚</span> Mis cursos
        </RouterLink>
        <RouterLink to="/instructor/examenes">
          <span class="icon">📝</span> Mis exámenes
        </RouterLink>
        <RouterLink to="/instructor/estudiantes">
...
.sidebar {
  width: 230px; background: #2e1065; color: white;
...
nav a {
  ...
  color: #c4b5fd; text-decoration: none; font-size: 0.95rem; transition: all 0.15s;
}
nav a:hover, nav a.router-link-active { background: #4c1d95; color: white; }
.icon { font-size: 1rem; }
.logout-btn {
