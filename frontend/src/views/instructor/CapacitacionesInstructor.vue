...
<template>
  <div class="page-container">
    ...
    <EmptyState v-else-if="courses.length === 0" class="slide-down-enter-active" title="Aún no has creado cursos"
    ...
    <div v-else class="courses-grid">
      <div v-for="c in courses" :key="c.id" class="course-card slide-down-enter-active">
        <div class="course-thumb"
          :style="{ background: c.thumbnail_url ? 'var(--surface-soft)' : (c.color || '#f97316') }">
          ...
          <div class="thumb-badges">
            ...
            <span class="badge badge-gray" style="background:rgba(255,255,255,0.9);color:#000">{{ c.type === 'course' ||
              c.type === 'mixto' ? 'Curso' : c.type }}</span>
        ...
        <div class="course-body">
          ...
          <div class="course-footer">
            <div class="course-code-wrapper">
              ...
              <button v-if="c.codigo_acceso" class="btn-text small text-muted" @click="resetCode(c.id, true)"
                title="Generar un nuevo código (el actual dejará de funcionar)">↻ Rotar</button>
            </div>
            ...
            <div
              ...
              <div style="display:flex;align-items:center;gap:8px;margin-left:auto;">
                ...
                <button class="toggle-btn" :class="{ on: c.is_public }" @click="togglePublic(c)"
    ...
    <CourseWizardModal v-if="showWizard" @close="showWizard = false" @created="fetchCourses(); showWizard = false" />
